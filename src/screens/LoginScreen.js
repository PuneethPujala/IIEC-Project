                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}>
                    ...
                    <View>
                        <View style={s.formCard}>
                            ...
                            <PremiumInput
                                ...
                                rightElement={
                                    <TouchableOpacity onPress={() => setShowPw(!showPw)}>
                                        <Text style={{ fontSize: 14 }}>{showPw ? '🙈' : '👁️'}</Text>
                                    </TouchableOpacity>
                                }
                            />
                            ...
                            <TouchableOpacity onPress={handleLogin} disabled={loading} activeOpacity={0.9} style={s.submitWrap}>
                    ...
                    <View>
                        <TouchableOpacity onPress={() => navigation.navigate('Signup')} style={s.switchRow}>
